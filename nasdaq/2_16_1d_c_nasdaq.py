...
def backtesting_medias_moviles_exponenciales(ticker, fecha_inicio, fecha_fin):
    try:
        ...
        # Calcular medias móviles exponenciales de 2 y 16 periodos
        ...
        data['Signal'] = 0
        data.loc[data['EMA2'] > data['EMA16'], 'Signal'] = 1
        data.loc[data['EMA2'] < data['EMA16'], 'Signal'] = -1
...
print(f"Beneficio total de la estrategia combinada utilizando EMAs de 2 y 16 periodos: {beneficio_total:.2f}%")
