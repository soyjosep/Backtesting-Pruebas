...
# Calcular la media móvil exponencial rápida (1 día) y lenta (5 días)
...
data['Signal'] = 0
data.iloc[5:, data.columns.get_loc('Signal')] = np.where(data['EMA1'][5:] > data['EMA5'][5:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA1 y EMA5) - Solo Compras - Diario')
plt.legend()
plt.show()
