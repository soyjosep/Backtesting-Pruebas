...
# Calcular la media móvil exponencial rápida (2 días) y lenta (13 días)
...
data['Signal'] = 0
data.iloc[13:, data.columns.get_loc('Signal')] = np.where(data['EMA2'][13:] > data['EMA13'][13:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA2 y EMA13) - Solo Compras - Diario')
plt.legend()
plt.show()
