...
# Calcular la media móvil exponencial rápida (1 día) y lenta (17 días)
data['EMA1'] = data['Close'].ewm(span=1, adjust=False).mean()
...
data['Signal'] = 0
data.iloc[17:, data.columns.get_loc('Signal')] = np.where(data['EMA1'][17:] > data['EMA17'][17:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA1 y EMA17) - Solo Compras - Diario')
plt.legend()
plt.show()
