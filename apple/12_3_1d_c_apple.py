...
# Calcular la media móvil exponencial rápida (3 días) y lenta (12 días)
...
data['Signal'] = 0
data.iloc[12:, data.columns.get_loc('Signal')] = np.where(data['EMA3'][12:] > data['EMA12'][12:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA3 y EMA12) - Solo Compras - Diario')
plt.legend()
plt.show()
