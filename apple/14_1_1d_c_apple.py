...
# Calcular la media móvil exponencial rápida (1 día) y lenta (14 días)
...
data['Signal'] = 0
data.iloc[14:, data.columns.get_loc('Signal')] = np.where(data['EMA1'][14:] > data['EMA14'][14:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA1 y EMA14) - Solo Compras - Diario')
plt.legend()
plt.show()
