...
# Calcular la media móvil exponencial rápida (3 días) y lenta (13 días)
...
data['Signal'] = 0
data.iloc[13:, data.columns.get_loc('Signal')] = np.where(data['EMA3'][13:] > data['EMA13'][13:], 1, 0)
...
plt.plot(data['Cumulative Market Return'], label='Retorno del Mercado')
plt.plot(data['Cumulative Strategy Return'], label='Retorno de la Estrategia')
plt.title('Estrategia de Backtesting de EMAs (3 y 13 días) en Bitcoin - Solo Compras')
plt.xlabel('Fecha')
