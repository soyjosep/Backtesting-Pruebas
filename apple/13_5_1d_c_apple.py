...
# Calcular la media móvil exponencial rápida (5 días) y lenta (13 días)
...
data['Signal'] = 0
data.iloc[13:, data.columns.get_loc('Signal')] = np.where(data['EMA5'][13:] > data['EMA13'][13:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA5 y EMA13) - Solo Compras - Diario')
plt.legend()
plt.show()
