...
# Calcular la media móvil exponencial rápida (7 días) y lenta (15 días)
...
data['Signal'] = 0
data.iloc[15:, data.columns.get_loc('Signal')] = np.where(data['EMA7'][15:] > data['EMA15'][15:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA7 y EMA15) - Solo Compras - Diario')
plt.legend()
plt.show()
