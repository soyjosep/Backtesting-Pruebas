...
# Calcular la media móvil exponencial rápida (1 día) y lenta (13 días)
...
data['Signal'] = 0
data.iloc[13:, data.columns.get_loc('Signal')] = np.where(data['EMA1'][13:] > data['EMA13'][13:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA1 y EMA13) - Solo Compras - Diario')
plt.legend()
plt.show()
