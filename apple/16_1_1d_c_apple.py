...
# Calcular la media móvil exponencial rápida (1 día) y lenta (16 días)
...
data['Signal'] = 0
data.iloc[16:, data.columns.get_loc('Signal')] = np.where(data['EMA1'][16:] > data['EMA16'][16:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA1 y EMA16) - Solo Compras - Diario')
plt.legend()
plt.show()
