...
# Calcular la media móvil exponencial rápida (2 días) y lenta (14 días)
...
data['Signal'] = 0
data.iloc[14:, data.columns.get_loc('Signal')] = np.where(data['EMA2'][14:] > data['EMA14'][14:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA2 y EMA14) - Solo Compras - Diario')
plt.legend()
plt.show()
