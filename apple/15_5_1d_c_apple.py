...
data['Signal'] = 0
data.iloc[15:, data.columns.get_loc('Signal')] = np.where(data['EMA5'][15:] > data['EMA15'][15:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA5 y EMA15) - Solo Compras')
plt.legend()
plt.show()
