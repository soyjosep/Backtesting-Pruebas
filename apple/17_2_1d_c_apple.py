...
# Calcular la media móvil exponencial rápida (2 días) y lenta (17 días)
...
data['Signal'] = 0
data.iloc[17:, data.columns.get_loc('Signal')] = np.where(data['EMA2'][17:] > data['EMA17'][17:], 1, 0)
...
plt.title('Estrategia de Backtesting de Medias Móviles Exponenciales (EMA2 y EMA17) - Solo Compras - Diario')
plt.legend()
plt.show()
