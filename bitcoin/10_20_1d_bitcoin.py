...
# Calcular la media móvil exponencial rápida (10 días) y lenta (20 días)
data['EMA10'] = data['Close'].ewm(span=10, adjust=False).mean()
data['EMA20'] = data['Close'].ewm(span=20, adjust=False).mean()

# Crear las señales de compra y cierre de posiciones (sin posiciones en corto)
data['Signal'] = 0
data.iloc[20:, data.columns.get_loc('Signal')] = np.where(data['EMA10'][20:] > data['EMA20'][20:], 1, 0)
...
plt.title('Estrategia de EMAs (10 y 20 días) en Bitcoin - Solo Compras')
plt.xlabel('Fecha')
